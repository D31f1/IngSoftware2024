 ...
 */
@Service
public class CategoriaProductoService implements CategoriaProductoRepository {
    ...
    @Override
    public void deleteInBatch(Iterable<CategoriaProducto> entities) {
        CategoriaProductoRepository.super.deleteInBatch(entities); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
    ...
    @Override
    public <S extends CategoriaProducto, R> R findBy(Example<S> example, Function<FluentQuery.FetchableFluentQuery<S>, R> queryFunction) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
