    ...
    public Producto updateProducto(Long id, Producto producto){
        ...
        if(existingProducto.isPresent()){
            ...
            if(!producto.getCodigo().equals(updatedProducto.getCodigo())){ //Se esta cambiando el codigo de producto
                ...
                if(p.isPresent()){
                    throw new ResourceNotFoundException("Ya existe un producto con codigo: " + producto.getCategoria().getId());
                } else {
            ...
            if(producto.getVariantes() != null && !producto.getVariantes().isEmpty()){
                // por si no hay variantes en el producto tener inicializado el array por si hay que agregar variantes
